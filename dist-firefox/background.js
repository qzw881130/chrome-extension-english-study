...
function incrementStoredValue(_x) {
  return _incrementStoredValue.apply(this, arguments);
}
function _incrementStoredValue() {
  _incrementStoredValue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tabId) {
    var _data$tabId;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.storage.local.get(tabId);
        case 2:
          data = _context2.sent;
          currentValue = (_data$tabId = data === null || data === void 0 ? void 0 : data[tabId]) !== null && _data$tabId !== void 0 ? _data$tabId : 0;
          return _context2.abrupt("return", webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.storage.local.set(_defineProperty({}, tabId, currentValue + 1)));
        case 5:
        case "end":
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.runtime.onInstalled.addListener(function () {
  init().then(function () {
